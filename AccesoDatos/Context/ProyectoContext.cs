...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server = localhost; Database = proyecto; Trust Server Certificate = true; User Id=Udemy; Password = admin; MultipleActiveResultSets = true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F9F46126C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FAEBAFC09");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F4FF7E9C6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F688E9342");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC725E343F1");
